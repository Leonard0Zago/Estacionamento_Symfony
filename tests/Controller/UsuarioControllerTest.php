...
class UsuarioControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'usuario[nome]' => 'Testing',
            'usuario[CPF]' => 'Testing',
            'usuario[datanasc]' => 'Testing',
        ]);
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            'usuario[nome]' => 'Something New',
            'usuario[CPF]' => 'Something New',
            'usuario[datanasc]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getDatanasc());
    }
